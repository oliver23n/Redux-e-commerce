...
//   UPDATE_PRODUCTS,
// } from '../utils/actions';
import { REMOVE_FROM_CART, UPDATE_CART_QUANTITY, ADD_TO_CART, UPDATE_PRODUCTS } from '../utils/store';
...
function Detail() {
  ...
  const addToCart = () => {
    ...
    if (itemInCart) {
      dispatch(UPDATE_CART_QUANTITY({ _id: id, purchaseQuantity: parseInt(itemInCart.purchaseQuantity)+1}));
      idbPromise('cart', 'put', {
        ...itemInCart,
